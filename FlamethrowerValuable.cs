...
public class FlamethrowerValuable : MonoBehaviour
{
	...
	public float triggerPositionMultiplier = 1f;
	...
	public void SetTriggerMeshPosition(bool pulled)
	{
		if (!triggerStuck)
		{
			if (pulled)
			{
				Vector3 localEulerAngles = new Vector3(triggerMeshInitialEulerAngles.x, triggerMeshInitialEulerAngles.y, triggerMeshInitialEulerAngles.z - 40f * triggerPositionMultiplier);
